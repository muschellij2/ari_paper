...
with \pkg{ari}) are overlaid with white noise for demonstration. This
...
LibreOffice, which \CRANpkg{docxtractr}, versions \texttt{0.6.2} and
...
\CRANpkg{googleLanguageR} for Google.
